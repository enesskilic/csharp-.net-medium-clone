<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="post.aspx.cs" Inherits="medium_clone.post" %>
...
<head runat="server">
    ...
    <title></title>
    <link rel="stylesheet" type="text/css" href="~/Content/css/style.css?t=<%= DateTime.Now.Ticks %>" media="screen" runat="server" />
</head>
<body>
    <form id="form1" runat="server">
        ...
        <nav class="navbar navbar-inverse">
            <div class="container">
                ...
                <ul class="nav-list">
                    <li class="nav-item">
                        <a class="nav-link" href="/home/?register">yazar ol</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/home/?login">giriş yap</a>
                    </li>
                    <li class="nav-item">
                        <a class="btn btn-primary" href="/home/?login">keşfet</a>
                    </li>
                </ul>
                <%}%>
            </div>
                        ...
                        <div class="post">
                            <div class="post-header">
                                <div class="post-title">
                                    <h1 id="post_title"><%= data_table.Rows[0]["title"] %> </h1>
                                </div>
                                <div class="post-subtitle">
                                </div>
                                <div class="post-user">
                                    <div class="post-user-avatar">
                                        <img src=" <%= data_table.Rows[0]["avatar"] %> " />
                                    </div>
                                    <div class="post-user-info">
                                        <a href="/user/?<%= data_table.Rows[0]["author_id"].ToString() %>" class="post-user-info-username"><%= data_table.Rows[0]["author"] %></a>
                                        <div class="post-info">
                                            <span class="post-info-date"><%= data_table.Rows[0]["date_name"] %></span>
                                            <span class="post-info-divider">-</span>
                                            <span class="post-info-read"><%= data_table.Rows[0]["read_time"] %> dakika </span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div id="post_content" class="post-content" runat="server">
                                <%= data_table.Rows[0]["content"] %>
                            </div>
                        </div>
                        <%} %>
                        <% else
